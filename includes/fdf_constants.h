...
# define CROSSHAIR_IMAGE_PATH "assets/crosshair.png"

# define CAMERA_INIT_ROTATION_X M_PI_4
# define CAMERA_INIT_ROTATION_Y 0.955316
# define CAMERA_INIT_ZOOM 40
# define INIT_HEIGHT_AMPLIFIER 0.1
# define INIT_LINE_SIZE 3

# define MIN_CAMERA_ZOOM
# define MAX_CAMERA_ZOOM
...
# define HEIGHTMAP_DISP_SPEED 12
...
# define TEXT_COLOR_ERROR 0xCC2222FF
# define BASE_LINE_COLOR 0x333333FF
# define LOW_LINE_COLOR 0x002288FF
# define HIGH_LINE_COLOR 0xEE4444FF
# define LOW_HEIGHTMAP_FOCUS_COLOR 0x2244FFFF
# define HIGH_HEIGHTMAP_FOCUS_COLOR 0x881133FF
